...
const Working = () => {
  return (
    <div id="working" className="w-full bg-white py-[60px]">
      <motion.div
        initial="hidden"
        whileInView="visible"
        variants={slideUpVariants}
        className="lg:w-[80%] w-[90%] m-auto flex flex-col justify-between items-center gap-[20px]"
      >
        ...
        >
          {planning.map((item, index) => (
            <div key={index} className="flex flex-col justify-center items-center gap-5 border-2 border-yellow-500 rounded-lg p-6">
